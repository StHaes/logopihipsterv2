...
public class ModeResourceIntTest {
    ...
    public void createMode() throws Exception {
        ...
        restModeMockMvc.perform(post("/api/modes")
            ...
            .content(TestUtil.convertObjectToJsonBytes(mode)))
        ...
        assertThat(testMode.getCode()).isEqualTo(DEFAULT_CODE);
        assertThat(testMode.getLabel()).isEqualTo(DEFAULT_LABEL);
    }
    ...
    public void updateMode() throws Exception {
        ...
        restModeMockMvc.perform(put("/api/modes")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(updatedMode)))
            .andExpect(status().isOk());
        ...
        Mode testMode = modeList.get(modeList.size() - 1);
        assertThat(testMode.getCode()).isEqualTo(UPDATED_CODE);
        assertThat(testMode.getLabel()).isEqualTo(UPDATED_LABEL);
    }
